      ...
      _default = (function (_QSWhitelistBase) {
        ...
        _createClass(_default, [{
          ...
          value: function init() {
            ...
            return Promise.all([_get(Object.getPrototypeOf(_default.prototype), 'init', this).call(this), this.safeTokens.load(), this.unsafeKeys.load(), this.trackerDomains.load()]).then(function () {
              events.sub('attrack:updated_config', _this.onConfigUpdate);
            });
          }
        }, {
          key: 'destroy',
