System.register('antitracking/tp_events', ['core/cliqz', 'antitracking/background', 'antitracking/attrack', 'antitracking/md5', 'antitracking/domain', 'platform/browser'], function (_export) {

    // Class to hold a page load and third party urls loaded by this page.
    'use strict';

    var utils, background, CliqzAttrack, md5, sameGeneralDomain, browser, stats, PageEventTracker;
    ...
    return {
        ...
        execute: function () {
            ...
            PageEventTracker = (function () {
                function PageEventTracker(telemetryCallback) {
                    _classCallCheck(this, PageEventTracker);
                ...
                _createClass(PageEventTracker, [{
                    ...
                    key: 'get',
                    value: function get(url, url_parts, ref, ref_parts, source) {
                    ...
                    key: 'commit',
                    value: function commit(force_clean, force_stage) {
                    ...
                    key: 'push',
                    value: function push(force_push) {
                        var now = new Date().getTime();
                    ...
                    key: 'incrementStat',
                    value: function incrementStat(req_log, stat_key, n) {
                        if (req_log != null) {
            ...
            _export('default', PageEventTracker);
        }
    };
});