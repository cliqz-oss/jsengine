System.register('antitracking/block-log', ['antitracking/persistent-state', 'antitracking/pacemaker', 'antitracking/md5', 'core/cliqz', 'antitracking/time', 'core/resource-loader'], function (_export) {
  'use strict';

  var persist, pacemaker, md5, events, datetime, ResourceLoader, DAYS_EXPIRE, TokenDomain, BlockLog, _default;
  ...
  return {
    ...
    execute: function () {
      ...
      _default = (function () {
        function _default(qsWhitelist, telemetry) {
